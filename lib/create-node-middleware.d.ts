 ...
 * ```
 */
export declare function createNodeMiddleware(appFn: ApplicationFunction, { probot, webhooksPath, adapter }?: MiddlewareOptions): (request: IncomingMessage, response: ServerResponse, next?: () => void) => Promise<boolean>;
